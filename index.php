...
<head>
    ...
    <title> Talnet| Home</title>  <link href="assets/img/avatar.png" rel="shortcut icon" sizes="250x250"> 
...
<body>
    <header class="hidden-sm hidden-md hidden-lg" style="background-color: #3B6889;">
        <div class="searchbox">
            <form action="search.php?town=$town&estate=$estate" id="searching">
                <h1 class="text-left"> Talnet<font style="font-size:19px;">.ke</font></h1>
<div class="searchbox">
 <form method="post" action="search.php?town=$town&estate=$estate" id="searching"><input hidden value="" type="text" name="estate"  id="estate" >
           <input type="text" name="town" id="town"placeholder="Search Your Town" style="background-color: white;" required>
            <input hidden type="button" class="post2" style=" border: 0; color:white; font-weight: bold; float: left;  padding: 2px 4px; background-color:#228B22;">
        <input type="submit" value="Search &#128269;"class="post" style=" border: 0; color:white; font-weight: bold; float: left; padding: 2px 4px; background-color:#228B22;"></form></div></form></div><p>
        <div > <a href="https://www.rentnyumba.co.ke"><font color="white">MAIN PAGE |</font></a>
         ...
         <a href="contact-us.php"><font color="white">CONTACT US |</font></a> <a href="about-us.php"><font color="white">ABOUT US</font></a></div>
        ...
        <nav class="navbar navbar-default hidden-xs navigation-clean">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                   ...
                   <form action="search.php?town=$town&estate=$estate" class="navbar-form navbar-left" id="searching2">
                        <div class="searchbox" >
        ...
        <input type="submit" class="post" style="background-color:  #3B6889; border-color:  #3B6889;  font-size: inherit; border: 0.2em solid  #3B6889;  background-color:  #3B6889;border-left: 0;padding: 0 0.75em;color: white;font-weight: bold; outline: 0;cursor: pointer; height:30px;" value=" SEARCH &#128269;" ></form>
                    ...
                    <ul class="nav navbar-nav hidden-md hidden-lg navbar-right">
                        ...
                        <li class="dropdown open"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="#">User <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <?php if (Login::isLoggedIn()) {echo '<li role="presentation"><a href="posts.php?username='; echo $username; echo '">'; echo $username; echo '</a></li>';} else { echo '<li role="presentation"><a href="https://www.rentnyumba.co.ke">Main Page</a></li><li role="presentation"><a href="index.php">Home</a></li>';}?>
                                <li class="divider" role="presentation"></li>
                                <?php if (Login::isLoggedIn()) { echo '<li role="presentation"><a href="index.php">Home</a></li>'; echo ' <li role="presentation"><a href="about-us.php">About Us </a></li><li role="presentation"><a href="contact-us.php">Contact Us</a></li>'; echo ' <li role="presentation"><a href="change-password.php">Change Password </a></li>';  echo ' <li role="presentation"><a href="logout.php">Log Out </a></li>';} else { echo ' <li role="presentation"><a href="about-us.php">About Us </a></li><li role="presentation"><a href="contact-us.php">Contact Us</a></li>'; echo '<li role="presentation"><a href="login.php">Log In</a></li>'; echo '<li role="presentation"><a href="create-account.php">Sign Up</a></li>';}?>
                            </ul>
                        </li>
                    ...
                    <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right">
                       ...
                       <?php if (Login::isLoggedIn()) { echo '<li role="presentation"><a href="https://www.rentnyumba.co.ke">Main Page</a></li><li role="presentation"><a href="posts.php?username='; echo $username; echo '">'; echo $username; echo '</a></li>';echo '<li role="presentation"><a href="newpost.php?username='; echo $username; echo '">NEW POST</a></li>'; } else { echo '<li role="presentation"><a href="https://www.rentnyumba.co.ke">Main Page</a></li><li role="presentation"><a href="login.php">LOGIN</a></li>'; echo '<li role="presentation"><a href="create-account.php">SIGN UP</a></li>';}?>
    ...
    <div class="container">
        <h1>Rental Houses </h1></div>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <ul class="list-group">
                         <?php if (Login::isLoggedIn()) {echo '<font size="3px">Welcome! <font color="grey">'; echo $username; echo '</font> </br><font size="2px" color="red"></br>NOTE: We may have limited posts due to  our site being new to the market.</font><font size="2px"> </font></font>';}else{ echo '<font color="grey" size="2px">Welcome to Rentnyumba.ke, A kenyan site where landowners get connected with tenants on the click of a button. <font size="2px" color="red"></br>NOTE: We may have limited posts due to  our site being new to the market.</font></font>'; }?>
